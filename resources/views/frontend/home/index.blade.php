...
<head>
  ...
  <meta name="description" content="This is a web based system for organizations where they can customize and set up their own environment to conduct voting with advanced powerful feature and secured environment" />
  <meta name="keywords" content="online-voting, e-voting" />
  ...
  <link rel="stylesheet" href="{{ asset('frontendAssets/fonts/feather/style.css') }}">
...
<body>
    ...
    <div class="container">
      ...
      <nav class="site-nav">
        <div class="logo">
          <a href="#" class="text-white">Online Voting</a>
        </div>
    ...
    <div class="hero-slant overlay" data-stellar-background-ratio="0.5" style="background-image: url('{{ asset('frontendAssets/images/hero-min.jpg') }}')">

      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-lg-7 intro">
            <h1 class="text-white font-weight-bold mb-4" data-aos="fade-up" data-aos-delay="0">Customize you Election</h1>
            <p class="text-white mb-4" data-aos="fade-up" data-aos-delay="100">Customize the system according to your need</p>
      ...
      <div class="slant" style="background-image: url('{{ asset('frontendAssets/images/slant.svg') }}');"></div>
    </div>
        ...
        <div class="row align-items-stretch">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="unit-4 d-flex">
              ...
              <div>
                <h3>Customizable</h3>
                <p>User can customize their own voting policies. They can create as many positions, ballot papers, time scheduling, cadidates profile etc.</p>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="unit-4 d-flex">
              ...
              <div>
                ...
                <p>This will provide powerful secure voting advanced features such as real time live voting, advanced result accessibility settings.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4 d-flex">
              ...
              <div>
                <h3>Free Support</h3>
                <p>24/7 our support system will be available</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row feature align-items-center justify-content-between">
          <div class="col-lg-7 section-stack order-lg-2 mb-4 mb-lg-0 position-relative" data-aos="fade-up" data-aos-delay="0">
            ...
            <div class="image-stack">
              <div class="image-stack__item image-stack__item--top">
                <img src="{{ asset('frontendAssets/images/img_h_2-min.jpg') }}" alt="">
              </div>
              <div class="image-stack__item image-stack__item--bottom">
                <img src="{{ asset('frontendAssets/images/img_h_3-min.jpg') }}" alt="">
              </div>
            </div>
          ...
          <div class="col-lg-4 section-title" data-aos="fade-up" data-aos-delay="100">
            ...
            <h2 class="font-weight-bold mb-4 heading">About us</h2>
            <p class="mb-4">This is a web based system for organizations where they can customize and set up their own environment to conduct voting with advanced powerful feature and secured environment</p>
        ...
        <div class="section-title text-center mb-5" data-aos="fade-up" data-aos-delay="0">
          ...
          <div class="switch-plan">
            ...
            <div class="d-inline-flex align-items-center">
              ...
              <div class="period"><span class="mr-2">Yearly</span></div>
            </div>
            ...
            <div class="testimonial--wrap">
              <div class="owl-single owl-carousel no-dots no-nav">
                ...
                <div class="testimonial-item">
                  <div class="d-flex align-items-center mb-4">
                    <div class="photo mr-3">
                      <img src="{{ asset('frontendAssets/images/person_1-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="author">
                      <cite class="d-block mb-0">Kaila Woodland</cite>
                      <span>Owner, Greenland, Inc.</span>
                ...
                <div class="testimonial-item">
                  <div class="d-flex align-items-center mb-4">
                    <div class="photo mr-3">
                      <img src="{{ asset('frontendAssets/images/person_2-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="author">
                      <cite class="d-block mb-0">Kaila Woodland</cite>
                      <span>Owner, Greenland, Inc.</span>
...
<div class="section-grey bg-light">
    ...
    <script src="{{ asset('frontendAssets/js/jquery-migrate-3.0.0.min.js') }}"></script>
    ...
    <script src="{{ asset('frontendAssets/js/imagesloaded.pkgd.js') }}"></script>
