...
<head>
  ...
  <!--favicon-->
  <link rel="icon" href="{{ asset('backendAssets/assets/images/favicon.ico') }}" type="image/x-icon">
  <!-- Vector CSS -->
	...
	<footer class="footer">
      <div class="container">
        <div class="text-center">
            <p>Copyright © <?php $year = date("Y"); echo $year; ?> All rights reserved. Developed by <a href="https://yeaminrabbi.eduanalytic.com/" target="_blank">Yeamin Rabbi</a></p>
        </div>
      </div>
    </footer>
	<!--End footer-->
