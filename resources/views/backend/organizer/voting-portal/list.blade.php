                    ...
                    @if ($portals->isNotEmpty())
                        ...
                        @foreach ($portals as $key => $data)
                          <tr>
                            ...
                            <td>
                                @if ($data->status == 0)
                                  <a href="{{ route('portalActive-organizer', $data->id) }}" class="btn btn-dark">Make Active</a>
                                  <a href="{{ route('portalChange-organizer', $data->id) }}" class="btn btn-primary">Change</a>
                                  <a href="{{ route('portalView-organizer', $data->id) }}" class="btn btn-warning">View</a>
