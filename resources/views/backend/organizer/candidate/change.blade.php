    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <form action="{{ route('CandidateUpdate-organizer') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                          ...
                          <a href="{{ route('portalChange-organizer', $candidate->voting_portal_id) }}"  class="btn btn-dark btn-round px-5">Back</a>
                        </div>
                    </form>
                </div>
